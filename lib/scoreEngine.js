...
export const DIM_TO_TAGS = {
  // "Nature & environment" and "Food & hospitality" were in the chip list but
  // in no dimension here. dimsOfTag returned [] for them, so they scored zero
  // affinity against every world — and because affinity is an average, a
  // student who said "I care about nature" had every world's score pulled down
  // for saying it, and the tag could never surface Renewables, Environmental
  // engineering or Agronomist. The careers themselves settle the mapping:
  // renewables R3/I2, env-eng I3/R2, agronomist R3/I2 and vet I3/R2 all load on
  // R and I. Food and hospitality genuinely spans making the food (R), serving
  // people (S) and running the place (E), so it sits in all three.
  R: ["Machines & hardware", "Building things", "Sport & movement",
      "Nature & environment", "Food & hospitality"],
  I: ["Mathematics", "Science & research", "Programming", "Nature & environment"],
  A: ["Design & creativity", "Media & video", "Languages & writing", "Music & performance"],
  S: ["People & communication", "Teaching & mentoring", "Health & body", "Food & hospitality"],
  E: ["Economics & finance", "People & communication", "Law & society", "Food & hospitality"],
