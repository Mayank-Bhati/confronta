...
const DEFAULTS = { profiles: [], activeId: null, lang: "en", theme: "dark", saved: [], guestHistory: [] };
...
export function loadStore() {
  ...
  try {
    ...
    return { ...DEFAULTS, ...parsed, profiles: parsed.profiles || [], saved: parsed.saved || [], guestHistory: parsed.guestHistory || [] };
  } catch {
    return { ...DEFAULTS };
  }
}
