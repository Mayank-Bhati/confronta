...
def main():
    ...
    if cmd == "init":
        ...
        print(seed())
    elif cmd == "seed-admissions":
        from careercompass_pipeline.seed_admissions import seed_admissions
        print(seed_admissions())
        ...
        if target == "polito":
            ...
            print(polimi.ingest())
        elif target == "polimi-manifesto":
            from careercompass_pipeline.adapters import polimi
            print(polimi.ingest_manifesto())
        elif target == "polimi-llm":
            from careercompass_pipeline.adapters import polimi
            print(polimi.enrich_subjects())
        elif target == "universitaly":
